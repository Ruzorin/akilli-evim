...
> Mutfak tezgahını tepeden gören IP kamera ile Qwen-VL Max kullanarak anlık tarif, teknik uyarılar ve iğneleyici şef eleştirileri.
...
- [ ] Qwen-VL Max API anahtarı ayarlandı
